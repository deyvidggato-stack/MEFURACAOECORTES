    ...
    {open && <section className="support-chat" aria-label="Atendimento">
      ...
      {view === "online" && !token && <>
        ...
        <form className="support-start" onSubmit={submitAccess}>
          ...
          <div className="social-login-info"><strong>Login com Google ou Facebook</strong><span>Entre no Atendimento IA da M&E com seu nome, sobrenome e senha.</span><div className="social-login-buttons"><button type="button" className="ai-login" onClick={() => { setFeedback("O Atendimento IA da M&E será ativado aqui."); }}>G <span>Entrar com IA</span></button><button type="button" className="password-login" onClick={() => { setFeedback("Crie seu acesso com nome, sobrenome e senha."); }}><Facebook size={17} fill="currentColor" /> <span>Criar acesso</span></button></div></div>
